...
Shader "Shader Forge/Water" {
    Properties {
        ...
        _OutwardWavesDomain ("Outward Waves Domain", Range(0, 20)) = 10
        _OutwardWavesSpeed ("Outward Waves Speed", Range(0, 10)) = 0
        _FoamThreshold ("Foam Threshold", Range(0, 1)) = 0.6617864
        _OtwardsWavesBias ("Otwards Waves Bias", Range(-5, 5)) = 0
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
...
////// Specular:
                ...
                float node_5452 = (_OutwardWavesDomain*i.uv0.g);
                float node_2814 = (1.0 - (node_5452-_OtwardsWavesBias));
                ...
                float node_8200 = saturate(((node_2814+_node_1091_var.r)-(i.uv0.g+_Edge)));
